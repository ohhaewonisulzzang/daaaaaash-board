    ...
    return (
      <div className="w-full">
        ...
        <input
          type={type}
          className={cn(
            "w-full px-4 py-3 bg-glass-light dark:bg-glass-dark border border-glass-border-light dark:border-glass-border-dark rounded-xl text-primary-text dark:text-dark-text text-base placeholder-primary-text-muted dark:placeholder-dark-text-muted backdrop-blur-md transition-all duration-300 focus:outline-none focus:border-accent-blue focus:ring-2 focus:ring-accent-blue/20 focus:shadow-lg hover:scale-[1.01]",
